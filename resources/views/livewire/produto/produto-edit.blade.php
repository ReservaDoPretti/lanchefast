<div class="container mt-4">
    ...
    <form wire:submit.prevent="update" enctype="multipart/form-data" class="mt-4">
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="imagem" class="form-label"><i class="bi bi-image"></i> Nova Imagem (opcional)</label>
            ...
            @if ($imagem)
                <div class="mt-3">
                    <strong>Preview da Nova Imagem:</strong><br>
                    <img src="{{ $imagem->temporaryUrl() }}" class="img-thumbnail" style="max-height: 200px;">
                </div>
            @elseif ($imagem_atual)
                <div class="mt-3">
                    <strong>Imagem Atual:</strong><br>
                    <img src="{{ asset('storage/' . $imagem_atual) }}" class="img-thumbnail" style="max-height: 200px;">
                </div>
            @endif
        </div>

        <button type="submit" class="btn btn-success">
            <i class="bi bi-save2"></i> Atualizar Produto
        </button>
    </form>
</div>
